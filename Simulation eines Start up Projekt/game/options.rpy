...
define config.name = _("Simulation eines Start up Projekt")
...
define build.name = "SimulationeinesStartupProjekt"
...
define config.save_directory = "SimulationeinesStartupProjekt-1737013598"
